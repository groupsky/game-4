...
export function getChallengeDefinitions() {
  return [
    ...
    // 11. Energy Storage Mastery (same as 8, demonstrates understanding)
    {
      ...
      description: 'Demonstrate your understanding! Build a circuit with a capacitor and batteries. Charge the capacitor to at least 1.5V and light an LED.',
      unlocked: false,
      completed: false,
      validator: (circuit) => ChallengeValidators.validateEnergyBank(circuit),
      stars: { optimalComponents: 4 }
    ...
    // 12. Triple Chain
    {
      ...
      description: 'Connect 3 LEDs in series with 3 batteries. See how voltage divides across series components - each LED gets a share!',
      unlocked: false,
      completed: false,
